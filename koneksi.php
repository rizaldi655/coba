...
// }
// else {
// 	$data = mysqli_query($this->koneksi, "select * from tb_barang where nama_barang like '%".$_GET['key']."%'");
// }
...
function cari($key)
{
	$data = mysqli_query($this->koneksi, "select * from tb_barang where nama_barang like '%".$key."%'");
	while($row = mysqli_fetch_array($data)){
